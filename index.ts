...
// Question 3
    ...
    let fruitTargetElement:number = 3;
    let thirdFruit1:string = fruits[fruitTargetElement-1];
...
// Question 4
    ...
    let numberTargetElement:number = 2;
    // console.log(numbers);
...
// Question 10
    ...
    let newFruits:string[] = ['pineapple', 'pear'];
    let q10RemovedFruits:string[] = fruits.splice(2, 0, ...newFruits);
